...
export async function createAccountBtn_click(event) {
    ...
    if (wixLocation.query.signupMode === 'google') {
        const sessionToken = await registerNewUserGoogle(email, wixLocation.query.googleUserId, { contactInfo: { firstName: firstName, lastName: lastName, picture: profilePhoto } });
    ...
    } else if (wixLocation.query.signupMode === 'facebook') {
        const sessionToken = await registerNewUserFacebook(email, wixLocation.query.facebookUserId, { contactInfo: { firstName: firstName, lastName: lastName, picture: profilePhoto }});
