...
$w.onReady(async function () {
	...
	let breadcrumbItems = [];
    breadcrumbItems.push({'label': 'All Topics', 'link': article['link-help-topics-1-all']}, {'label': article.category, 'link': article['link-copy-of-help-topics-1-all']}, {'label': article.title, 'link': article['link-help-topics-title'], 'isCurrent': true});
